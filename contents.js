...
document.addEventListener('click', function (event) {
  ...
  if (!document.querySelector('.hover-option-button') && highlightedText.classList.contains('highlight')) {
    ...
    button1.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_yc3PpZbdcqK_kxW_fi3w0Zr1joyA_mF4tg&s';
    button2.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTC57ZcBfxoCaD4o9QV8f4RiR6OToUFcv4Gug&s';
    button3.src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXPSQpSSbjaF-6GBsVUjsKjitxAL2bC8oDVg&s';
    ...
    button3.addEventListener('click',()=>{
      ...
      result = confirm("Are you sure you wish to delete this aesthetically appealing highlighted text?");
